<form action="" method="POST" target="_blank" class="flex flex-row flex-wrap w-full">
    <div class="lg:w-[47%] w-full mx-auto mb-8">
        <label for="name" class="block mb-2 text-md font-medium text-[#01224F]">Nom & Prénom</label>
    ...
    <div class="lg:w-[47%] w-full mx-auto mb-8">
        <label for="tel" class="block mb-2 text-md font-medium text-[#01224F]">N° Téléphone</label>
    ...
    <div class="lg:w-[47%] w-full mx-auto mb-8">
        <label for="email" class="block mb-2 text-md font-medium text-[#01224F]">Email</label>
    ...
    <div class="lg:w-[47%] w-full mx-auto mb-8">
        <label for="services" class="block mb-2 text-md font-medium text-[#01224F]">Service</label>
        <select id="services"
            class="bg-slate-50 border text-gray-900 text-lg lg:rounded-[18px] placeholder-[#B5CFEF] border-[#B5CFEF] block w-full py-4 px-6">
    ...
    <div class="w-[96%] mx-auto">
        <label for="email" class="block mb-2 text-md font-medium text-[#01224F]">Message</label>
        <textarea name="message" id="message" class="bg-slate-50 border text-gray-900 text-lg lg:rounded-[18px] placeholder-[#B5CFEF] border-[#B5CFEF] block w-full py-4 px-6" cols="70" rows="8" placeholder="Inserez votre message" required></textarea>
    </div>
    <input type="button" name="" id="btnSubmit" value="Confirmer le rendez-vous" class="form-cta mx-auto mt-10" />
</form>
